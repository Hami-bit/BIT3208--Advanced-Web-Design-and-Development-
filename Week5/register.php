    ...
    <div class="form-container">
        ...
        <form method="POST" action="register.php" id="registerForm">
            ...
            <div class="form-group">
                ...
                <input type="password" id="regPassword" name="password" placeholder="Minimum 8 characters">
                ...
                <div class="password-strength" id="passwordStrength" style="margin-top:8px;">
                    <div class="strength-bar" style="height:8px;background:#e2e8f0;border-radius:6px;overflow:hidden;">
                        <div id="strengthFill" style="width:0%;height:100%;background:#e53e3e;"></div>
                    </div>
                    <small id="strengthText" style="display:block;margin-top:6px;color:#4a5568;">Password strength: N/A</small>
                </div>
            </div>
